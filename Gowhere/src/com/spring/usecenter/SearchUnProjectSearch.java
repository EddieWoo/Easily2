...
public class SearchUnProjectSearch extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.uc_searchproject);
...
// ---------------创建日历控件
		...
		ArrayList<HashMap<String, Object>> remoteWindowItem = new ArrayList<HashMap<String, Object>>();
			...
			map.put("list_image", R.drawable.project6);// 图像资源的ID
			map.put("pname", "羽绒制品企业补充流动资金");
			map.put("prate", "13.00%");
			map.put("ifn", "300");
			remoteWindowItem.add(map);
			
			map = new HashMap<String, Object>();
			map.put("list_image", R.drawable.project7);// 图像资源的ID
			map.put("pname", "民办中学综合改造投入");
			map.put("prate", "14.50%");
			map.put("ifn", "1000");
			remoteWindowItem.add(map);
			
			map = new HashMap<String, Object>();
			map.put("list_image", R.drawable.project8);// 图像资源的ID
			map.put("pname", "餐饮企业店面扩建及装修");
			map.put("prate", "14.00%");
			map.put("ifn", "500");
			remoteWindowItem.add(map);
		...
		//选择查询条件
			public void show_search_way_dialog(View v){
				new AlertDialog.Builder(SearchUnProjectSearch.this)
				.setIcon(getResources().getDrawable(R.drawable.login_error_icon))
				.setTitle("请选择")
				.setSingleChoiceItems(new String[]{"进行中项目名称", "时间范围"},0,
