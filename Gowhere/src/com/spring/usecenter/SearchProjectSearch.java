...
public class SearchProjectSearch  extends ListActivity {
...
// ---------------创建日历控件
		...
		// ----------------创建list显示查询结果-
				...
				ArrayList<HashMap<String, Object>> remoteWindowItem = new ArrayList<HashMap<String, Object>>();
					...
					map.put("list_image", R.drawable.project1);// 图像资源的ID
					map.put("pname", "幕墙门窗生产流动资金");
					map.put("prate", "13.50%");
					map.put("ifn", "3000");
					remoteWindowItem.add(map);
					
					map = new HashMap<String, Object>();
					map.put("list_image", R.drawable.project2);// 图像资源的ID
					map.put("pname", "陶瓷制造生产设备采购");
					map.put("prate", "14.50%");
					map.put("ifn", "10000");
					remoteWindowItem.add(map);
					
					map = new HashMap<String, Object>();
					map.put("list_image", R.drawable.project3);// 图像资源的ID
					map.put("pname", "红木家具企业补充流动资金");
					map.put("prate", "14.00%");
					map.put("ifn", "5000");
					remoteWindowItem.add(map);
					
					map = new HashMap<String, Object>();
					map.put("list_image", R.drawable.project4);// 图像资源的ID
					map.put("pname", "小家电商贸企业补充流动资金");
					map.put("prate", "13.00%");
					map.put("ifn", "2000");
					remoteWindowItem.add(map);
					
					map = new HashMap<String, Object>();
					map.put("list_image", R.drawable.project5);// 图像资源的ID
					map.put("pname", "丝绸制品企业补充流动资金");
					map.put("prate", "14.50%");
					map.put("ifn", "7000");
					remoteWindowItem.add(map);
				...
				SimpleAdapter listItemAdapter = new SimpleAdapter(this,
						...
						R.layout.project_ls,// ListItem的XML实现
						// 动态数组与ImageItem对应的子项
		...
		//选择查询条件
			public void show_search_way_dialog(View v){
				new AlertDialog.Builder(SearchProjectSearch.this)
