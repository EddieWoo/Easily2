...
public class SearchUnProductSearch extends ListActivity {
...
// ---------------创建日历控件
		...
		//选择查询条件
			public void show_search_way_dialog(View v){
				new AlertDialog.Builder(SearchUnProductSearch.this)
